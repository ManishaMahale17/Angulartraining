...
console.log("-----------------------------------------------------------------");
let stmt=str.split(". ");
console.log(`Number of statements in string is: ${stmt.length}`);

console.log("-----------------------------------------------------------------");


let count = (str.length);
console.log("Number of letters in string is:");
console.log(count);
console.log("-----------------------------------------------------------------");
let words=str.split(" ");
console.log(`Number of words in string is: ${words.length}`);
