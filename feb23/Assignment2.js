var city = ["Pune", "Mumbai", "Goa", "Hydrabad", "Ahmednagar", "Panjab", "Delhi"];
...
city.sort(function (s1, s2) { return s1.length - s2.length; });
console.log(city);
console.log("-----------------------------------------------------------------");
console.log("Sort an array based on Length of each String in array in descending order");
city.sort(function (s1, s2) { return s2.length - s1.length; });
console.log(city);
console.log("-----------------------------------------------------------------");
